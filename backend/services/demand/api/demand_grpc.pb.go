...
func (c *demandServiceClient) GetDemands(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*DemandsRes, error) {
...
func _DemandService_GetDemands_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemandServiceServer).GetDemands(ctx, req.(*emptypb.Empty))
	}
