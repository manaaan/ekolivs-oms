...
replace (
	github.com/manaaan/ekolivs-oms/backend/jobs/sync_products => ../../jobs/sync_products
	github.com/manaaan/ekolivs-oms/backend/pkg => ../../pkg
	github.com/manaaan/ekolivs-oms/backend/specs => ../../specs
)
