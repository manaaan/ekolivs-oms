...
const (
	...
	DemandService_GetDemand_FullMethodName    = "/DemandService/GetDemand"
...
type DemandServiceClient interface {
	...
	GetDemand(ctx context.Context, in *IdReq, opts ...grpc.CallOption) (*Demand, error)
...
func (c *demandServiceClient) GetDemand(ctx context.Context, in *IdReq, opts ...grpc.CallOption) (*Demand, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Demand)
...
type DemandServiceServer interface {
	...
	GetDemand(context.Context, *IdReq) (*Demand, error)
...
func (UnimplementedDemandServiceServer) GetDemand(context.Context, *IdReq) (*Demand, error) {
...
func _DemandService_GetDemand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemandServiceServer).GetDemand(ctx, req.(*IdReq))
	}
	return interceptor(ctx, in, info, handler)
}
